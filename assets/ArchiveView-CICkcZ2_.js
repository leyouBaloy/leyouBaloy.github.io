import{i as ne,w as te,f as ge,o as re,d as G,r as $,h as g,c as j,t as I,p as et,n as ue,m as Yt,F as q,g as qt,k as Jt,v as Kt,H as Qt,I as Zt,_ as $e,q as E,s as V,e as ea,A as O,B as ae,D as tt,E as at,u as X,z as J,x as N,J as ta,G as ee,K as ce}from"./index-Dp9A9AOX.js";import{c as aa,a as Oe,z as na,f as ra,b as oa,u as ia,A as nt,S as la,v as Ve,N as sa,w as Me,B as Se,o as da,j as Ne,V as Te,m as fe,d as ca,l as be,y as Fe}from"./fade-in-scale-up.cssr-DcUg5iPR.js";import{u as fa,s as he,t as ba,d as l,m as h,g as Pe,f as rt,o as ua,n as ke,a as B,e as W,c as ot,h as me,k as it,v as pa,j as F,N as va}from"./Nav-BFkHxWLo.js";import{u as lt,k as st,g as ha,r as ga,N as ma,o as xa,a as ya}from"./BackTop-BWRpPCSB.js";function Ca(e,t,a){const o=ne(e,null);o!==null&&(t in o||(o[t]=[]),o[t].push(a.value),te(a,(i,f)=>{const b=o[t],s=b.findIndex(x=>x===f);~s&&b.splice(s,1),b.push(i)}),ge(()=>{const i=o[t],f=i.findIndex(b=>b===a.value);~f&&i.splice(f,1)}))}function Sa(e,t,a){const o=ne(e,null);o!==null&&(t in o||(o[t]=[]),re(()=>{const i=a();i&&o[t].push(i)}),ge(()=>{const i=o[t],f=a(),b=i.findIndex(s=>s===f);~b&&i.splice(b,1)}))}const Ta=Oe(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[Oe("&::-webkit-scrollbar",{width:0,height:0})]),wa=G({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=$(null);function t(i){!(i.currentTarget.offsetWidth<i.currentTarget.scrollWidth)||i.deltaY===0||(i.currentTarget.scrollLeft+=i.deltaY+i.deltaX,i.preventDefault())}const a=fa();return Ta.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:aa,ssr:a}),Object.assign({selfRef:e,handleWheel:t},{scrollTo(...i){var f;(f=e.value)===null||f===void 0||f.scrollTo(...i)}})},render(){return g("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});var Ra=/\s/;function ka(e){for(var t=e.length;t--&&Ra.test(e.charAt(t)););return t}var _a=/^\s+/;function $a(e){return e&&e.slice(0,ka(e)+1).replace(_a,"")}var Ge=NaN,Pa=/^[-+]0x[0-9a-f]+$/i,Ba=/^0b[01]+$/i,za=/^0o[0-7]+$/i,La=parseInt;function De(e){if(typeof e=="number")return e;if(na(e))return Ge;if(he(e)){var t=typeof e.valueOf=="function"?e.valueOf():e;e=he(t)?t+"":t}if(typeof e!="string")return e===0?e:+e;e=$a(e);var a=Ba.test(e);return a||za.test(e)?La(e.slice(2),a?2:8):Pa.test(e)?Ge:+e}var we=function(){return ba.Date.now()},Aa="Expected a function",Ea=Math.max,Wa=Math.min;function ja(e,t,a){var o,i,f,b,s,x,v=0,m=!1,k=!1,P=!0;if(typeof e!="function")throw new TypeError(Aa);t=De(t)||0,he(a)&&(m=!!a.leading,k="maxWait"in a,f=k?Ea(De(a.maxWait)||0,t):f,P="trailing"in a?!!a.trailing:P);function R(u){var y=o,H=i;return o=i=void 0,v=u,b=e.apply(H,y),b}function S(u){return v=u,s=setTimeout(c,t),m?R(u):b}function C(u){var y=u-x,H=u-v,D=t-y;return k?Wa(D,f-H):D}function d(u){var y=u-x,H=u-v;return x===void 0||y>=t||y<0||k&&H>=f}function c(){var u=we();if(d(u))return _(u);s=setTimeout(c,C(u))}function _(u){return s=void 0,P&&o?R(u):(o=i=void 0,b)}function A(){s!==void 0&&clearTimeout(s),v=0,o=x=i=s=void 0}function z(){return s===void 0?b:_(we())}function w(){var u=we(),y=d(u);if(o=arguments,i=this,x=u,y){if(s===void 0)return S(x);if(k)return clearTimeout(s),s=setTimeout(c,t),R(x)}return s===void 0&&(s=setTimeout(c,t)),b}return w.cancel=A,w.flush=z,w}var Ha="Expected a function";function pe(e,t,a){var o=!0,i=!0;if(typeof e!="function")throw new TypeError(Ha);return he(a)&&(o="leading"in a?!!a.leading:o,i="trailing"in a?!!a.trailing:i),ja(e,t,{leading:o,maxWait:t,trailing:i})}function Ia(e){return e instanceof HTMLElement?e.scrollTop:window.scrollY}function Oa(e){return e instanceof HTMLElement?e.getBoundingClientRect():{top:0,bottom:window.innerHeight}}const Va=l("affix",[h("affixed",{position:"fixed"},[h("absolute-positioned",{position:"absolute"})])]),Be={listenTo:[String,Object,Function],top:Number,bottom:Number,triggerTop:Number,triggerBottom:Number,position:{type:String,default:"fixed"},offsetTop:{type:Number,validator:()=>!0,default:void 0},offsetBottom:{type:Number,validator:()=>!0,default:void 0},target:{type:Function,validator:()=>!0,default:void 0}},Ma=st(Be),Na=G({name:"Affix",props:Be,setup(e){const{mergedClsPrefixRef:t}=Pe(e);ra("-affix",Va,t);let a=null;const o=$(!1),i=$(!1),f=$(null),b=$(null),s=j(()=>i.value||o.value),x=j(()=>{var d,c;return(c=(d=e.triggerTop)!==null&&d!==void 0?d:e.offsetTop)!==null&&c!==void 0?c:e.top}),v=j(()=>{var d,c;return(c=(d=e.top)!==null&&d!==void 0?d:e.triggerTop)!==null&&c!==void 0?c:e.offsetTop}),m=j(()=>{var d,c;return(c=(d=e.bottom)!==null&&d!==void 0?d:e.triggerBottom)!==null&&c!==void 0?c:e.offsetBottom}),k=j(()=>{var d,c;return(c=(d=e.triggerBottom)!==null&&d!==void 0?d:e.offsetBottom)!==null&&c!==void 0?c:e.bottom}),P=$(null),R=()=>{const{target:d,listenTo:c}=e;d?a=d():c?a=lt(c):a=document,a&&(a.addEventListener("scroll",S),S())};function S(){oa(C)}function C(){const{value:d}=P;if(!a||!d)return;const c=Ia(a);if(s.value){b.value!==null&&c<b.value&&(o.value=!1,b.value=null),f.value!==null&&c>f.value&&(i.value=!1,f.value=null);return}const _=Oa(a),A=d.getBoundingClientRect(),z=A.top-_.top,w=_.bottom-A.bottom,u=x.value,y=k.value;u!==void 0&&z<=u?(o.value=!0,b.value=c-(u-z)):(o.value=!1,b.value=null),y!==void 0&&w<=y?(i.value=!0,f.value=c+y-w):(i.value=!1,f.value=null)}return re(()=>{R()}),ge(()=>{a&&a.removeEventListener("scroll",S)}),{selfRef:P,affixed:s,mergedClsPrefix:t,mergedstyle:j(()=>{const d={};return o.value&&x.value!==void 0&&v.value!==void 0&&(d.top=`${v.value}px`),i.value&&k.value!==void 0&&m.value!==void 0&&(d.bottom=`${m.value}px`),d})}},render(){const{mergedClsPrefix:e}=this;return g("div",{ref:"selfRef",class:[`${e}-affix`,{[`${e}-affix--affixed`]:this.affixed,[`${e}-affix--absolute-positioned`]:this.position==="absolute"}],style:this.mergedstyle},this.$slots)}}),Fa=G({name:"Add",render(){return g("svg",{width:"512",height:"512",viewBox:"0 0 512 512",fill:"none",xmlns:"http://www.w3.org/2000/svg"},g("path",{d:"M256 112V400M400 256H112",stroke:"currentColor","stroke-width":"32","stroke-linecap":"round","stroke-linejoin":"round"}))}}),Ga={linkFontSize:"13px",linkPadding:"0 0 0 16px",railWidth:"4px"},Da=e=>{const{borderRadius:t,railColor:a,primaryColor:o,primaryColorHover:i,primaryColorPressed:f,textColor2:b}=e;return Object.assign(Object.assign({},Ga),{borderRadius:t,railColor:a,railColorActive:o,linkColor:ua(o,{alpha:.15}),linkTextColor:b,linkTextColorHover:i,linkTextColorPressed:f,linkTextColorActive:o})},Ua={name:"Anchor",common:rt,self:Da},Xa=l("anchor",`
 position: relative;
`,[ke("block",`

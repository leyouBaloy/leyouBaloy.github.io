...
`,[P("input, textarea",`
 ...
 `),["warning","error"].map(e=>ie(`${e}-status`,[Ke("disabled",[B("base-loading",`
...
`,[B("pagination-prefix",`
 ...
 `)]),Ke("disabled",[ie("hover",Gn,qn),Q("&:hover",Gn,qn),Q("&:active",`

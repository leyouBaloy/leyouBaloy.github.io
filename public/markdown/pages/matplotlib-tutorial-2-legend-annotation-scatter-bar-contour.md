# matplotlib学习笔记（二）Legend图例-Annotation标注-tick能见度-Scatter散点图-Bar柱状图-Contours等高线图

> 发布于：2021-02-25 | 分类：笔记 | 原文：https://leyoubaloy.github.io/post/matplotlib-tutorial-2-legend-annotation-scatter-bar-contour
